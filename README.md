...
Hacker News App, showing of public Hacker News 

### Tech

Hacker New Apps uses a number of open source projects and propose architecture to work properly:
...
And of course Hacker News App itself is open source with a [public repository][dill]
 on GitHub.
